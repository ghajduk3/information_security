...
iptables -A OUTPUT -p tcp -m multiport --ports 80,443,22 -m state --state NEW -j ACCEPT
iptables -A INPUT -p tcp -m multiport --port 80,443,22 -m state --state NEW -j ACCEPT
### FORWARDING RULES
